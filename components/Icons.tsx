...
export function MainboardIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GpuIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M6 18v3M18 18v3M2 10H1M2 14H1" />
    </svg>
  );
}

export function RamIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SsdIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PsuIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CaseIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CoolingIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M12 12c0-3.5 2.5-5 4-5s2 1.5 2 3-2.5 3.5-6 2" />
      <path d="M12 12c3.5 0 5 2.5 5 4s-1.5 2-3 2-3.5-2.5-2-6" />
      <path d="M12 12c0 3.5-2.5 5-4 5s-2-1.5-2-3 2.5-3.5 6-2" />
      <path d="M12 12c-3.5 0-5-2.5-5-4s1.5-2 3-2 3.5 2.5 2 6" />
      <circle cx="12" cy="12" r="2" />
    </svg>
  );
}

export function MouseIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function KeyboardIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MonitorIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TruckIcon({ size = 18, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function getCategoryIcon(iconName: string, size = 18, className = "") {
  switch (iconName) {
    case "cpu":
      return <CpuIcon size={size} className={className} />;
    case "mainboard":
      return <MainboardIcon size={size} className={className} />;
    case "gpu":
      return <GpuIcon size={size} className={className} />;
    case "ram":
      return <RamIcon size={size} className={className} />;
    case "ssd":
      return <SsdIcon size={size} className={className} />;
    case "psu":
      return <PsuIcon size={size} className={className} />;
    case "case":
      return <CaseIcon size={size} className={className} />;
    case "cooling":
      return <CoolingIcon size={size} className={className} />;
    case "mouse":
      return <MouseIcon size={size} className={className} />;
    case "keyboard":
      return <KeyboardIcon size={size} className={className} />;
    case "monitor":
